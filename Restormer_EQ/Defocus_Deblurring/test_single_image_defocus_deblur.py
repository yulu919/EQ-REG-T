...
parser.add_argument('--result_dir', default='./results/Single_Image_Defocus_Deblurring_loss/', type=str, help='Directory for results')
...
####### Load yaml #######
yaml_file = 'Options/DefocusDeblur_Single_8bit_Restormer_loss.yml'
import yaml
