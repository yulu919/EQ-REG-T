...
# # 检查源路径
# inputL_path = os.path.join(src, 'train', 'inputL')
# print(f"Checking path: {inputL_path}")
# if not os.path.exists(inputL_path):
#     print("Path does not exist.")
# else:
#     print("Path exists. Files in the directory:")
#     print(os.listdir(inputL_path))

# # 检查文件列表
# lrL_files = natsorted(glob(os.path.join(inputL_path, '*.png')))
# print(f"Number of files found: {len(lrL_files)}")
# if len(lrL_files) == 0:
#     print("No files found. Check file extensions or directory structure.")
