...
from basicsr.models.archs.restormer_loss_arch import Restormer_loss
import cv2
import utils
...
parser.add_argument('--result_dir', default='./results/Dual_Pixel_Defocus_Deblurring_loss/', type=str, help='Directory for results')
...
####### Load yaml #######
yaml_file = 'Options/DefocusDeblur_DualPixel_16bit_Restormer_loss.yml'
import yaml
...
model_restoration = Restormer_loss(**x['network_g'])
