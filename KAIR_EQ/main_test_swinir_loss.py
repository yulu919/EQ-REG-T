...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='/data/byl/loss_constraint_equi/KAIR/results/superresolution/swinir_sr_classical_patch48_x3/models/500000_G.pth')
    parser.add_argument('--folder_lq', type=str, default='testsets/Set14/LR_bicubic/X3', help='input low-quality test image folder')
...
def setup(args):
    ...
    if args.task in ['classical_sr', 'lightweight_sr']:
        save_dir = f'results/swinir_loss_{args.task}_x{args.scale}'
    ...
    # 004 grayscale image denoising/ 005 color image denoising
        ...
        save_dir = f'results/swinir_loss_{args.task}_noise{args.noise}'
        folder = args.folder_gt
        border = 0
        window_size = 8
